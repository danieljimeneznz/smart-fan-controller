...
uint16_t PowerController::readVoltage(uint8_t channel) {
// 	if channel == (10){
// 		ADMUXA |=	(0<<MUX5)| // Set the current ADC MUX to ADC11 (Vm).
// 					(0<<MUX4)|
// 					(1<<MUX3)|
...
// we need to set ADSC back to 1 after each conversion i am unsure where to do this.

uint16_t PowerController::getPower(){
